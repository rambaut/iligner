...
/*!
@method     - (id)initWithName: (NSString *)aName content: (id)theContent;
...
/*!
@method     - (id)initWithName: (NSString *)aName intValue: (int)theContent;
...
/*!
@method     - (id)initWithName: (NSString *)aName floatValue: (float)theContent;
...
/*!
@method     - (id)initWithName: (NSString *)aName doubleValue: (double)theContent;
...
/*!
@method     - (id)initWithName: (NSString *)aName boolValue: (BOOL)theContent;
...
/*!
@method     + (id)annotationWithName: (NSString *)aName content: (id)theContent;
...
/*!
@method     + (id)annotationWithName: (NSString *)aName intValue: (int)theContent;
...
/*!
@method     + (id)annotationWithName: (NSString *)aName floatValue: (float)theContent;
...
/*!
@method     + (id)annotationWithName: (NSString *)aName doubleValue: (double)theContent;
...
/*!
@method     + (id)annotationWithName: (NSString *)aName boolValue: (BOOL)theContent;
...
/*!
@method     - (void)setName:(NSString *)newName;
@abstract   sets the name of the annotation
*/
- (void)setName:(NSString *)newName;

/*!
@method     - (NSObject *)content;
@abstract   returns the name of the content
*/
- (NSObject *)content;

/*!
@method     - (void)setContent:(NSObject *)newContent;
...
/*!
@method     - (BOOL)isEqualTo: (BCAnnotation *) otherAnnotation
...
/*!
@method     - (BOOL)isEqualToAnnotation: (BCAnnotation *) otherAnnotation
...
/*!
@method     - (NSComparisonResult)sortAnnotationsOnNameAscending:(BCAnnotation *) ann;
...
/*!
@method     - (NSComparisonResult)sortAnnotationsOnNameDescending:(BCAnnotation *) ann;
...
/*!
@method     - (NSComparisonResult)sortAnnotationsOnContentAscending:(BCAnnotation *) ann;
...
/*!
@method     - (NSComparisonResult)sortAnnotationsOnContentDescending:(BCAnnotation *) ann;
