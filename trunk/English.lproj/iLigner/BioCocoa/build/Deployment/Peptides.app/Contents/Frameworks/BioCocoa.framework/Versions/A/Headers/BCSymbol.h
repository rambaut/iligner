...
/*!
    @method     - (id)initWithSymbolChar:(unsigned char)aSymbol
...
/*!
    @method     - (unsigned char) symbolChar
...
/*!
    @method     - (NSDictionary	*) symbolInfo
...
/*!
    @method     - (id) valueForKey: (NSString *)aKey
...
/*!
    @method     - (void) setValue: (id)aValue forKey: (NSString *)theKey
...
/*!
    @method     representsSymbol: (BCSymbol *)entry;
...
/*!
    @method     isRepresentedBySymbol: (BCSymbol *)entry;
