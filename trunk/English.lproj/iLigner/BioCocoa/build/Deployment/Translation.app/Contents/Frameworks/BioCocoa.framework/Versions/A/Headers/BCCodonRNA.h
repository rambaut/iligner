...
/*!
     @method     - (BCCodonDNA *)initWithRNASequenceString: (NSString *)sequenceString andAminoAcidString: (NSString *)aaString
...
/*!
     @method     - (BOOL) matchesTriplet: (NSArray *)entry
