...
/*!
    ...
    * strings for a sequence in sorted order.  It is useful doing fast, simple
...
/*!
    ...
    @discussion Performs an on-the-fly union of a set of suffix arrays with an enumeration of
