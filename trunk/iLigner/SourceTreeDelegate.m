//
// File:       SourceTreeDelegate.m
//
// Abstract:   Implementation for the source tree delegate. Manages the drag and drop 
//             functionality in the outline view using the tree controller.
//
// Version:    1.0
//

#import "SourceTreeDelegate.h"

@implementation SourceTreeDelegate
...
- (NSString *)applicationSupportFolder {
    ...
    return [basePath stringByAppendingPathComponent:@"SourceTree"];
}
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    if (persistentStoreCoordinator == nil) {
        ...
        url = [NSURL fileURLWithPath:[applicationSupportFolder stringByAppendingPathComponent:@"SourceTree.xml"]];
...
NSString *AbstractTreeNodeType = @"SourceTreeNodeType";
